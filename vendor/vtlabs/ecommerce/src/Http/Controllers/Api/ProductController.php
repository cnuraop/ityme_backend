...
class ProductController extends Controller
{
    ...
    public function getTags()
    {
        ...
        // $tags =  DB::table('ecommerce_products')
        // ->join('ecommerce_tags', 'ecommerce_products.id', '=', 'ecommerce_tags.product_id')
        // ->select('ecommerce_tags.*', 'ecommerce_products.*')
        // ->where('ecommerce_tags.id', '=', '1')
        // ->get();

      $orders = Product::join('ecommerce_tags','ecommerce_tags.product_id','=','ecommerce_products.id')->get(['ecommerce_tags.*', 'ecommerce_products.*']);
      // return $orders;
      return $orders;
